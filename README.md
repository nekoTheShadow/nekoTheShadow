...
- SI業界の片隅でひっそり生きるシステムエンジニア。
    - 自動車業界を担当領域とし、技術リードおよびアーキテクトとしてのポジションを担っています。
    - チームリーダーとして、メンバーのマネージメントや新入社員の教育の経験もあります。
- 2025/06/30に現職を退職。現在は転職活動中ですが、キャリアブレイクも検討しています、
- 連絡をいただける際は、このプロフィール、もしくは、LAPRASのポートフォリオを見たことを添えていただくとスムーズです。
